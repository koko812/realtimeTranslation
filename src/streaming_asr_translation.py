...
def translate_text(text, target_lang="en"):
    result = unescape((translate_client.translate(text, target_language=target_lang)))
        ...
        for response in responses:
            for result in response.results:
                ...
                if result.is_final:
                    ...
                    logger.log_result(text, confidence, True, translation=translation)
                    print(f"✅ {text}")
                    print(f"🌍 → {translation}")
                else:
                    logger.log_result(text, confidence, False)
                    print(f"🔄 {text}")
